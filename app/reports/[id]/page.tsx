...
export default async function ReportDetailPage({ params }: Readonly<{params: Promise<{id: number}>}>) {
    ...
    return (
      <main className="flex flex-col items-center pt-10">
        ...
        <div className="border rounded-lg shadow-lg w-[50%] max-w-4xl p-6 bg-hblue-light/[0.5] border-hblue-light/[0.6] my-5">
            <div className="grid grid-cols-2 gap-4 text-center">
              ...
              <div>
                  ...
                  {report.dateCreated.toLocaleDateString('en-US', { year: "numeric", month: "long", day: "numeric" })}
                  </p>
              </div>
              <div>
                  <h2 className="font-semibold">Results</h2>
                  <p className="text-gray-700">
                    {report.containOSCC ? "OSCC Detected" : "No OSCC Detected"}
                  </p>
              </div>
              <div className="">
            ...
            <div className="flex items-center justify-center flex-col my-5">
                ...
                <img src={`${report.imageUrl}`} className="m-auto max-w-[50%]" alt=""></img>
            </div>
            ...
            <div className="border rounded-lg shadow-lg w-[50%] max-w-4xl p-6 bg-hblue-light/[0.5] border-hblue-light/[0.6] my-5">
                <Link href={`/patients/${report.patientId}`}>
                    <div className="grid grid-cols-2 gap-4 text-center ">
                        ...
                        <div className="hover:bg-hblue-light/[0.2]">
